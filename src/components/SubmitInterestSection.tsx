...
const ContactFormSection = () => {
  ...
  const [role, setRole] = useState(t("choose"));
    ...
    <section className="relative bg-white py-16 px-6 max-sm:px-0 md:py-24 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="bg-[#056438] rounded-none p-8 md:p-12 flex-1 w-[541px] max-sm:w-[360px] max-sm:px-10 max-sm:h-[504px] h-[564px] shadow-lg ml-10 rtl:ml-0 max-sm:rtl:ml-10 rtl:mr-10 max-sm:ml-0 mt-10">
          ...
          <p className="text-green-100 mb-4">{t("formdesc")}</p>
          ...
          <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="p-2 rounded-md focus:outline-none bg-white focus:ring-2 focus:ring-green-300"
              value={fullName}
            ...
            {/* Phone */}
            <label className="text-white text-sm font-medium">
              {t("phone")} <span className="text-[#FF3C00]">*</span>
            </label>
            <div className="flex gap-2">
              ...
              <input
                ...
                className="p-2 rounded-md w-full focus:outline-none bg-white focus:ring-2 focus:ring-green-300"
                value={phoneNumber}
            ...
            <RoleDropdown selected={role} setSelected={setRole} />

            {/* Button */}
            <button
              type="submit"
              disabled={loading}
              className="w-[116px] mt-2 bg-[#008346] hover:bg-[#008346b2] text-white py-3 px-6 rounded-full flex items-end self-end justify-end gap-2 transition-all disabled:opacity-50"
            >
